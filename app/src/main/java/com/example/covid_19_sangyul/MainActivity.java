...
import com.example.covid_19_sangyul.COVID_API;
...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textview_address = (TextView)findViewById(R.id.textView_addr); //현재 주소
        final TextView textview_city = (TextView)findViewById(R.id.textView_city); //현재 도시
        String address = getCurrentAddress(latitude, longitude); //현재 경,위도에 맞는 주소 받기
        textview_address.setText(address); //ex) 대한민국 부산광역시 남구 대연3동 448-6

        String city = "";

        //주소가 어디인지(제주 경남 경북 전남 전북 충남 충북 강원 경기 세종 울산 대전 광주 인천 대구 부산 서울)
        ...
        textview_city.setText(city); //도시이름 표시
        ...
        button_Progress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "진행 현황", Toast.LENGTH_SHORT).show();
            }
        });

        button_Distancing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "거리두기 단계 현황", Toast.LENGTH_SHORT).show();
            }
        });
